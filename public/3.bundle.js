	...
	var Details = function (_React$Component) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var show = this.assignShow(this.props.params.id);
	      Axios.get('http://www.omdbapi.com/?i=' + show.imdbID).then(function (response) {
	        _this2.setState({
	    ...
	    key: 'render',
	    value: function render() {
	      var _ref = this.assignShow(this.props.params.id) || {};
